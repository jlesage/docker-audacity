# Docker container for Audacity
[![Release](https://img.shields.io/github/release/jlesage/docker-audacity.svg?logo=github&style=for-the-badge)](https://github.com/jlesage/docker-audacity/releases/latest)
[![Docker Image Size](https://img.shields.io/docker/image-size/jlesage/audacity/latest?logo=docker&style=for-the-badge)](https://hub.docker.com/r/jlesage/audacity/tags)
[![Docker Pulls](https://img.shields.io/docker/pulls/jlesage/audacity?label=Pulls&logo=docker&style=for-the-badge)](https://hub.docker.com/r/jlesage/audacity)
[![Docker Stars](https://img.shields.io/docker/stars/jlesage/audacity?label=Stars&logo=docker&style=for-the-badge)](https://hub.docker.com/r/jlesage/audacity)
[![Build Status](https://img.shields.io/github/actions/workflow/status/jlesage/docker-audacity/build-image.yml?logo=github&branch=master&style=for-the-badge)](https://github.com/jlesage/docker-audacity/actions/workflows/build-image.yml)
[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg?style=for-the-badge)](https://paypal.me/JocelynLeSage)

This project provides a Docker container for [Audacity](https://www.audacityteam.org).
...
[![Audacity logo](https://images.weserv.nl/?url=raw.githubusercontent.com/jlesage/docker-templates/master/jlesage/images/audacity-icon.png&w=110)](https://www.audacityteam.org)[![Audacity](https://images.placeholders.dev/?width=256&height=110&fontFamily=monospace&fontWeight=400&fontSize=52&text=Audacity&bgColor=rgba(0,0,0,0.0)&textColor=rgba(121,121,121,1))](https://www.audacityteam.org)
...
Launch the Audacity docker container with the following command:

```shell
docker run -d \
    --name=audacity \
    -p 5800:5800 \
    -v /docker/appdata/audacity:/config:rw \
...
Where:
  ...
  - `/docker/appdata/audacity`: Stores the application's configuration, state, logs, and any files requiring persistency.
  - `/home/user`: Contains files from the host that need to be accessible to the application.
  - `/dev/sr0`: This is the Linux device file representing the optical drive.

Access the Audacity GUI by browsing to `http://your-host-ip:5800`.
...
|`WEB_AUDIO`| When set to `1`, enables audio support, allowing audio produced by the application to play through the browser. See [Web Audio](#web-audio) for details. | `1` |
...
services:
  audacity:
    image: jlesage/audacity
    ports:
      - "5800:5800"
    volumes:
      - "/docker/appdata/audacity:/config:rw"
...
[Releases]: https://github.com/jlesage/docker-audacity/releases
[Docker Hub]: https://hub.docker.com/r/jlesage/audacity/tags
...
container, it would proxy all HTTP requests for `audacity.domain.tld` to
...
server {
	...
	server_name audacity.domain.tld;

	location / {
		proxy_pass http://docker-audacity;
...
server {
	...
	location = /audacity {return 301 $scheme://$http_host/audacity/;}
	location /audacity/ {
		proxy_pass http://docker-audacity/;
		proxy_http_version 1.1;
		proxy_set_header Upgrade $http_upgrade;
...
| **Application version** label | Displays the version of Audacity integrated into Docker image. |
...
Any desktop notification generated by Audacity is forwarded to the
...
second, etc). To allow Audacity to access the first drive, use
this parameter:
...
[create a new issue](https://github.com/jlesage/docker-audacity/issues).
